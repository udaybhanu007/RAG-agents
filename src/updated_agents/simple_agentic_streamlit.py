...
This follows the exact same pattern as the agents folder streamlit app
with silent initialization and clean separation of concerns.
"""
...
# Initialize the agentic application (silent like agents folder)
def initialize_agentic_workflow():
    """Initialize the Enhanced Agentic RAG Application silently without UI messages"""
    try:
        from updated_agents.simple_agentic_app import enhanced_agentic_app
        
        # Silent initialization without any UI progress messages
        result = enhanced_agentic_app.initialize_system()
        success = result.get("status") == "success"
        return enhanced_agentic_app, success, None
